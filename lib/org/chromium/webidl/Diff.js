  ...
  classes: [
    {
      ...
      properties: [
        ...
        {
          class: 'String',
          documentation: 'Tracks the path to the property of the AST node.',
          name: 'path',
        },
        {
          class: 'Array',
  ...
  methods: [
    {
      ...
      code: function(left, right) {
        ...
        keys.forEach(function(key) {
          ...
          // the same source (e.g. Gecko), we will get an array of items.
    ...
    },
    {
      ...
      code: function(defnMap, key) {
        var id = this.Identifier.create({ name: key, path: '' });
