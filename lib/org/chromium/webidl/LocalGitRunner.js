...
foam.CLASS({
  ...
  properties: [
    ...
    },
    {
      ...
      documentation: 'Stores the name of the repository / source we are processing.',
      name: 'source',
    },
    {
      class: 'Class',
    ...
    },
    {
      ...
      of: 'foam.dao.DAO',
      documentation: `If provided, all IDL outputs will be forwarded to given
      ...
      code: function(path, resolve, reject, error, contents) {
        if (error) {
          ...
          if (this.urlOutputBox && urls.length > 0) {
            ...
            var urlMsg = this.PipelineMessage.create({
              parserClass: this.parserClass,
              source: this.source,
              urls: urls,
            });
