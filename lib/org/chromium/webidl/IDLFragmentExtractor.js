...
foam.CLASS({
  ...
  properties: [
    ...
    },
    {
      name: 'tagMatching_',
      documentation:
        `A state variable that changes as extract processes a file.
  ...
  methods: [
    ...
    },
    {
      ...
      documentation:
        `Action performed upon encountering an open <pre> token.
        ...
        text content is pushed into idlFragments, and the function returns
